...
scoped_ptr<TParams> GetAdjustedParsedArgs(scoped_ptr<base::ListValue>& args) {
...
bool SetStoreBrowserContext(const UIThreadExtensionFunction* function,
  const scoped_ptr<base::ListValue>& args,
  scoped_ptr<TParams>& parsedArgs,
...
scoped_ptr<api::cookies::Get::Params> WebViewInternalCookiesGetFunction::GetParsedArgs() {
...
scoped_ptr<api::cookies::GetAll::Params> WebViewInternalCookiesGetAllFunction::GetParsedArgs() {
...
scoped_ptr<api::cookies::Set::Params> WebViewInternalCookiesSetFunction::GetParsedArgs() {
...
scoped_ptr<api::cookies::Remove::Params> WebViewInternalCookiesRemoveFunction::GetParsedArgs() {
