...
scoped_ptr<api::cookies::Get::Params> CookiesGetFunction::GetParsedArgs() {
...
scoped_ptr<api::cookies::GetAll::Params> CookiesGetAllFunction::GetParsedArgs()
{
...
scoped_ptr<api::cookies::Set::Params> CookiesSetFunction::GetParsedArgs() {
...
scoped_ptr<api::cookies::Remove::Params> CookiesRemoveFunction::GetParsedArgs()
{
