...
class CookiesGetFunction : public ChromeAsyncExtensionFunction {
 ...
 private:
  virtual scoped_ptr<api::cookies::Get::Params> GetParsedArgs();
...
class CookiesGetAllFunction : public ChromeAsyncExtensionFunction {
 ...
 private:
  virtual scoped_ptr<api::cookies::GetAll::Params> GetParsedArgs();
  virtual bool SetStoreBrowserContext();
...
class CookiesSetFunction : public ChromeAsyncExtensionFunction {
 ...
 private:
  virtual scoped_ptr<api::cookies::Set::Params> GetParsedArgs();
  virtual bool SetStoreBrowserContext();
...
class CookiesRemoveFunction : public ChromeAsyncExtensionFunction {
 ...
 private: 
  virtual scoped_ptr<api::cookies::Remove::Params> GetParsedArgs();
  virtual bool SetStoreBrowserContext();
